<?php
    ...
    if (isset($_POST["submit"])) {
		//jika data terisi semua tidak ada yang kosong maka merefresh index.php(admin) dengan data baru yang telah ditambahkan
        if(tambahcalon($_POST) > 0){
            echo '<script>alert("Berhasil menambahkan data."); document.location="index.php";</script>';
        }else{
        	//jika data tidak terisi semua maka muncul pemberitahuan gagal menambahkan data
